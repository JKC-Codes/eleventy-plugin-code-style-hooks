...
test('does not highlight nested code blocks', t => {
	const js = `<code class="language-js">function test() {
	...
	t.is(addHooks(js), `<code class="language-js"><span class="token keyword">function</span> <span class="token function">test</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	<code class="language-css">.css {
		within: js;
	}</code>
...
test('keeps spacing', t => {
	const html = `<code class="language-html">
<p> foo </p>
</code>`;

	t.is(addHooks(html), `<code class="language-html">
<p> foo </p>
</code>`);
});
...
test('accepts multiple Prism languages', t => {
	...
	const css = `<code class="language-css">.foo {
	bar: baz;
}</code>`;
	const js = `<code class="language-js">function foo(bar) {
	return baz;
}</code>`
	const typescript = `<code class="language-typescript">interface Foo {
	bar: string;
	baz: number;
}</code>`;
	const ts = `<code class="language-ts">interface Foo {
	bar: string;
	baz: number;
}</code>`;
	...
	t.is(addHooks(css), `<code class="language-css"><span class="token selector">.foo</span> <span class="token punctuation">{</span>
	<span class="token property">bar</span><span class="token punctuation">:</span> baz<span class="token punctuation">;</span>
<span class="token punctuation">}</span></code>`);

	t.is(addHooks(js), `<code class="language-js"><span class="token keyword">function</span> <span class="token function">foo</span><span class="token punctuation">(</span><span class="token parameter">bar</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	<span class="token keyword">return</span> baz<span class="token punctuation">;</span>
<span class="token punctuation">}</span></code>`);

	t.is(addHooks(typescript), `<code class="language-typescript"><span class="token keyword">interface</span> <span class="token class-name">Foo</span> <span class="token punctuation">{</span>
	bar<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
	baz<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span></code>`);

	t.is(addHooks(ts), `<code class="language-ts"><span class="token keyword">interface</span> <span class="token class-name">Foo</span> <span class="token punctuation">{</span>
	bar<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
	baz<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span></code>`);
